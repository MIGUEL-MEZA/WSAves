...
WHERE OPNR.CvePerfilN = " + id;
            ...
            if (!dtPerfil.Columns.Contains("Response2"))
                throw new Exception("La tabla OptimizerG_PerfilN_Resultado no contiene la columna Response2. Es necesario aplicar primero el cambio de base de datos.");
        ...
        {
            string sql = $"SELECT * FROM CatOptimizerG_Referencias WHERE CveReferencia = {cveReferencia}";
